...
public class GenericUserPropertyGet extends ApplicationMessage {
     ...
     */
    public GenericUserPropertyGet(@NonNull final ApplicationKey appKey, @NonNull final DeviceProperty property) throws IllegalArgumentException {
        super(appKey);
