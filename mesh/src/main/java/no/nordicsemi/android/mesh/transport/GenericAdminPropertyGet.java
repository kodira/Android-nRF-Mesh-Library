...
public class GenericAdminPropertyGet extends ApplicationMessage {
     ...
     */
    public GenericAdminPropertyGet(@NonNull final ApplicationKey appKey, @NonNull final DeviceProperty property) throws IllegalArgumentException {
        super(appKey);
